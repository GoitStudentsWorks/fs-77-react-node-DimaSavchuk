...
`,ot=()=>t.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"89",height:"91",viewBox:"0 0 89 91",fill:"none",children:[t.jsx("path",{d:`M34.7168 90.9317C34.3738 90.9317 34.0449 90.7951 33.8024 90.5518C33.5599 
       ...
       88.2698 67.1542 88.252 67.3668 88.2852C67.5794 88.3184 67.7812 88.4017 67.9555 88.5283C68.1298
        88.6549 68.2718 88.8212 68.3696 89.0135C68.4675 89.2057 68.5185 89.4186 68.5185 89.6345C68.5185
         ...
         21.3845L59.1231 29.6597H73.2388L79.9223 21.3435L62.5534 21.3845Z`,fill:"#F3F3F3",fillOpacity:"0.1"}),t.jsx("path",{d:`M16.1116 34.8947C14.8634 34.8918 13.6196 34.7438 12.4043 34.4535C8.56254 33.5273 
       ...
       34.2605L20.1301 34.3983C18.815 34.7275 17.4658 34.8942 16.1116 34.8947Z`,fill:"#F3F3F3",fillOpacity:"0.1"})]}),nt=({data:p})=>{function c(l,o){const n=new Image;n.src=l,n.complete?o(!0):(n.onload=()=>{o(!0)},n.onerror=()=>{o(!1)})}return t.jsx(K,{children:p.map(({title:l,measure:o,thumbMedium:n},d)=>{let s=null;return c(n,x=>{x?s=!0:s=!1,n||(s=!1)}),t.jsxs("li",{children:[t.jsx(_,{children:s?t.jsx("img",{src:n,alt:l,style:{display:"block",width:"100%",height:"auto"}}):t.jsx(ot,{})}),t.jsxs(tt,{children:[t.jsx(et,{children:l}),t.jsx(it,{children:o||" "})]})]},d)})})},st="/fs-77-react-node-DimaSavchuk/assets/coctails-mob-18ca057d.jpg",rt="/fs-77-react-node-DimaSavchuk/assets/coctails-mob@2x-7b6104ad.jpg",at="/fs-77-react-node-DimaSavchuk/assets/coctails-tablet-9bb53f5b.jpg",ct="/fs-77-react-node-DimaSavchuk/assets/coctails-tablet@2x-6bd5ea57.jpg",lt="/fs-77-react-node-DimaSavchuk/assets/coctails-pc-0e4dd42f.jpg",dt="/fs-77-react-node-DimaSavchuk/assets/coctails-pc@2x-4b5efb24.jpg",pt=()=>t.jsxs("picture",{children:[t.jsx("source",{media:"(min-width: 1440px)",srcSet:`${lt} 1x, ${dt}`,type:"image/jpeg"}),t.jsx("source",{media:"(min-width: 768px)",srcSet:`${at} 1x, ${ct} 2x`,type:"image/jpeg"}),t.jsx("img",{srcSet:rt,src:st,alt:"picture",loading:"lazy"})]}),xt=()=>{const[p,c]=a.useState(null),[l,o]=a.useState(""),[n,d]=a.useState(!0),[s,x]=a.useState(!1),[r,m]=a.useState(null),{drinkId:g}=y();return a.useEffect(()=>{const u=new AbortController;(async()=>{try{d(!0),x(!1);const{data:h,idCurrentUser:f}=await A(g,u);o(f),c(...h),m(h[0].favorites.includes(f))}catch(h){x(h.message)}finally{d(!1),u.abort()}})()},[g]),{drinkInfo:p,userId:l,isLoading:n,error:s,isfavorite:r,setIsFavorite:m}},ht=[Z,B],ut=()=>{const[p,c]=a.useState(null),l=S(),o=I(),n=D($),[d,s]=a.useState(!1);console.log("Компонент мотивации должен рендерится в AboutDrinkPages",d),a.useEffect(()=>{n&&s(!0)},[n]),a.useEffect(()=>{const e=localStorage.getItem("wasMotivationFirstFavoriteShown");s(e!=="true")},[]),a.useEffect(()=>{o(z(l.pathname))},[o]);const x=()=>{s(!1),localStorage.setItem("wasMotivationFirstFavoriteShown","true")},{drinkInfo:r,userId:m,isLoading:g,error:u,isfavorite:v,setIsFavorite:h}=xt(),{drinkId:f}=y();function w(e){var C;h((C=e==null?void 0:e.favorites)==null?void 0:C.includes(m))}async function k(){try{c(!0);const e=await P(f);if(e.data&&j.success("Added to favorites"),w(e.data),e.firstFavorite)o(E(e.firstFavorite));else return}catch(e){o(M(e.message))}finally{c(!1)}}async function F(){try{c(!0);const e=await R(f);e&&j.success("Deleted from favorites"),w(e)}catch(e){console.log(e.message)}finally{c(!1)}}return t.jsxs(t.Fragment,{children:[t.jsx(H,{in:d,timeout:500,classNames:"motivation",unmountOnExit:!0,mountOnEnter:!0,children:t.jsx(O,{text:"Wow! You have added the first recipe to your favorites!",image:ht,onClose:x,isShown:d})}),t.jsxs(X,{children:[u&&t.jsx(L,{children:"Error!!!"}),g&&t.jsx(T,{bgc:"var(--loader-background-color-without-opacity)"}),r&&t.jsxs(t.Fragment,{children:[t.jsxs(U,{children:[t.jsxs("div",{children:[t.jsx(L,{children:r.drink}),t.jsxs(q,{children:[r.glass," / ",r.alcoholic]}),t.jsx(N,{children:r.description}),v?t.jsx(b,{type:"button",onClick:F,disabled:p,children:"Remove from favorites"}):t.jsx(b,{type:"button",onClick:k,disabled:p,children:"Add to favorite drinks"})]}),t.jsx(V,{children:t.jsx("img",{src:r.drinkThumb,alt:r.drink,style:{display:"block",width:"100%",height:"auto"}})})]}),t.jsx(Q,{children:"Ingredients"}),t.jsx(nt,{data:r.ingredients}),t.jsx(W,{children:"Recipe Preparation"}),t.jsxs(Y,{children:[t.jsx(G,{children:r.instructions}),t.jsx(J,{children:t.jsx(pt,{})})]})]})]})]})};export{ut as default};
